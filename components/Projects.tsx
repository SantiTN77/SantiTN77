            ...
            <article className="group overflow-hidden rounded-2xl border border-white/10 bg-zinc-900/30 p-5 transition-all duration-300 hover:border-white/20 sm:p-7">
              ...
              <div className="mt-4 flex flex-wrap items-start justify-between gap-4">
                ...
                <Link
                  ...
                  className="group/link inline-flex shrink-0 items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-white transition-all duration-300 hover:border-white/25 hover:bg-white/10"
                >
                  {item.cta}
