...
export function Experience() {
  return (
    <Section id="experience">
      <SectionHeading
        index="02"
        title="Enterprise Experience & Automations"
        subtitle="Core engineering outcomes shipped to production."
      />
      ...
      <div className="flex flex-col gap-5">
        {experience.map((item) => (
          <article
            key={item.company}
            className="group relative overflow-hidden rounded-2xl border border-white/10 bg-zinc-900/30 p-6 transition-all duration-300 hover:border-white/20 hover:bg-zinc-900/50 sm:p-8"
          >
